...
$(document.body).on('click', '.imporpt_calendar', function(e){
  e.preventDefault();
...
$(document.body).on('click', '#export_icalendar', function(e){
    e.preventDefault();
...
$("#front-search-form").submit(function(e) {
  e.preventDefault()
    var t = $("#startDate").val(),
        a = $("#endDate").val(),
        o = parseInt($(".adult_guests_value").val()),
        ch = parseInt($(".children_guests_value").val()),
        infants = $(".infant_guests_value").val(),
        pets = $(".pets_guests_value").val(),
        i = "";
    var n = $("#front-search-field").val(),
        c = n.replace(" ", "+");
    window.location.href = APP_URL + "/search?location=" + c + "&checkin=" + t + "&checkout=" + a + "&guest=" + o + "&children=" + ch + "&infants=" + infants + "&pets=" + pets, e.preventDefault()
});
