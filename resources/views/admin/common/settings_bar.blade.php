	...
	<div class="panel-body">
		...
		<ul class="nav navbar-pills nav-tabs nav-stacked no-margin" role="tablist">
			...
			@if(Permission::has_permission(Auth::guard('admin')->user()->id, 'manage_sms'))
				<li class="admin-none {{ (Route::current()->uri() == 'admin/settings/sms') ? 'active' : ''  }}">
			...
			@if(Helpers::has_permission(Auth::guard('admin')->user()->id, 'manage_discounts'))
				<li class="{{ (Route::current()->uri() == 'admin/settings/discounts' || Route::current()->uri() == 'admin/settings/add-discounts' || Route::current()->uri() == 'admin/settings/edit-discounts/{id}') ? 'active' : ''  }}">
					<a href="{{ url('admin/settings/discounts') }}" data-group="property_type">Discounts</a>
				</li>
			@endif
			...
			@if(Helpers::has_permission(Auth::guard('admin')->user()->id, 'manage_currency'))
				<li class="admin-none {{ (Route::current()->uri() == 'admin/settings/currency' || Route::current()->uri() == 'admin/settings/add-currency' || Route::current()->uri() == 'admin/settings/edit-currency/{id}') ? 'active' : ''  }}">
			...
			@if(Helpers::has_permission(Auth::guard('admin')->user()->id, 'manage_language'))
				<li class="admin-none {{ (Route::current()->uri() == 'admin/settings/language' || Route::current()->uri() == 'admin/settings/add-language' || Route::current()->uri() == 'admin/settings/edit-language/{id}') ? 'active' : ''  }}">
			...
			@if(Helpers::has_permission(Auth::guard('admin')->user()->id, 'manage_roles'))
				<li class="admin-none {{ (Route::current()->uri() == 'admin/settings/roles' || Route::current()->uri() == 'admin/permissions' || Route::current()->uri() == 'admin/settings/add-role' || Route::current()->uri() == 'admin/settings/edit-role/{id}') ? 'active' : ''  }}">
			...
			<li class="admin-none {{ (Route::current()->uri() == 'admin/backup') ? 'active' : ''  }}">
