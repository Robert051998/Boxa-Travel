<aside class="main-sidebar">
	...
	<ul class="sidebar-menu">
		...
		@if(Helpers::has_permission(Auth::guard('admin')->user()->id, 'manage_testimonial'))
			<li class="admin-none {{ (Route::current()->uri() == 'admin/testimonials') || (Route::current()->uri() == 'admin/edit-testimonials/{id}') || (Route::current()->uri() == 'admin/add-testimonials') ? 'active' : ''  }}"><a href="{{ url('admin/testimonials') }}"><i class="fa fa-quote-left"></i><span>Testimonials</span></a></li>
		@endif
		...
		@if(Helpers::has_permission(Auth::guard('admin')->user()->id, 'manage_messages'))
			<li class="admin-none {{ (Route::current()->uri() == 'admin/messages') || (Route::current()->uri() == 'admin/messaging/host/{id}') || (Route::current()->uri() == 'admin/send-message-email/{id}') ? 'active' : ''  }}">
		...
		@if(Helpers::has_permission(Auth::guard('admin')->user()->id, 'view_reports'))
			<li class="admin-none treeview {{ (Route::current()->uri() == 'admin/sales-report' || Route::current()->uri() == 'admin/sales-analysis' || Route::current()->uri() == 'admin/overview-stats') ? 'active' : ''  }}">
				<a href="#">
