    ...
    <form id="listing_pricing" method="post" action="{{url('admin/listing/'.$result->id.'/'.$step)}}" class='signup-form login-form' accept-charset='UTF-8'>
      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="col-md-4 l-pad-none">
              <label for="listing_pet_price_fee_native_checkbox" class="label-large label-inline">
                <input type="checkbox" data-extras="true" class="pricing_checkbox" data-rel="pet_price" {{($result->property_price->pet_price == 0)?'':'checked="checked"'}}>&nbsp
              Additional Pet Pricing
              </label>
            </div>
          
          <div id="pet_price" class="row {{($result->property_price->pet_price == 0)?'display-off':''}}">
            <div class="col-md-12">
              <div class="col-md-4 l-pad-none">
                <div class="input-addon">
                  <span class="input-prefix pay-currency">{!! $result->property_price->currency->org_symbol !!}</span>
                  <input type="text" data-extras="true" id="price-pet_price" value="{{ $result->property_price->pet_price }}" name="pet_price" class="money-input" data-saving="additional-saving">
                </div>
              </div>
            </div>
          </div>
