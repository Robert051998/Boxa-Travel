    ...
    <div class="row">
      ...
      <div class="col-md-9">
        <div class="box box-info">
          <div class="box-body">
            <div class="modal d-none z-index-high" id="hotel_date_package_admin" role="dialog">
            ...
            <div class="modal z-index-high d-none" id="import_calendar_package" role="dialog">
              <div class="modal-dialog">
                <!-- Modal content-->
                <div class="modal-content">
                  <div class="modal-header">
            ...
            <div class="modal z-index-high d-none" id="calendar_export_package" role="dialog">
              <div class="modal-dialog">
                <!-- Modal content-->
                    <div class="modal-content">
                        <div class="modal-header">
              ...
              <form method='post' action="admin/property-save/{{$result->id}}/pricing">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-6 text-right mt-30">
                    <a data-prevent-default="" href="{{ url('admin/properties') }}" class="btn btn-large btn-primary">Finish</a>
                  </div>
                </div>
              </form>
            </div>
