...
@section('main')
    ...
    <div class="modal d-none z-index-high" id="crop-modal" role="dialog">
    ...
    @push('scripts')
        ...
        <script type="text/javascript">
            ...
            $(document).on('submit', '#photo-form', function (e) {
                ...
                console.log("🚀 ~ file: photos.blade.php:224 ~ dataURL:", dataURL)
        ...
        $(document).ready(function () {
            $('#img_form').validate({
                ...
                submitHandler: function(form)
                {
                    ...
                    console.log("🚀 ~ file: photos.blade.php:436 ~ form:");
                    // return false;
