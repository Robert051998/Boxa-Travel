                    ...
                    <div class="col-md-12">
                        ...
                        @if(Session::has('message'))
                            <div class="row m-0 mt-3">
                                <div class="col-md-12  mb-0 alert {{ Session::get('alert-class') }} alert-dismissable top-message-text opacity-1">
                        ...
                        <div class="row justify-content-center mt-5">
                            <div class="col-md-12">
                                <form id='profile_update' class="profile_setting" method='post' action="{{url('users/profile')}}" onsubmit="return ageValidate();">
                                    {{ csrf_field() }}
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class='form-control ' type='text' name='details[live]' value="{{(isset($details['live']) && !empty($details['live'])) ? $details['live'] : '' }}" id='live' size='30' placeholder='e.g. Paris, FR / Brooklyn, NY / Chicago, IL'>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="float-right">
                                                <button type="submit" class="btn vbtn-outline-success" id="save_btn"><i class="spinner fa fa-spinner fa-spin d-none"></i>
