										...
										<div class="col-md-12 p-0">
											<div class="full-table mt-2 border text-dark rounded-3 pt-3 pb-3 mb-4 p-4">
												<p class="row margin-top10 text-justify text-16 mb-0">
													<span class="text-left col-sm-6 text-14">{{$booking->total_night}} {{trans('messages.property_single.night')}} </span>
                                                ...
                                                @if($booking->pets_charge)
                                                    <p class="row margin-top10 text-justify text-16">
                                                        <span class="text-left col-sm-6 text-14">{{trans('messages.home.pets')}}</span>
                                                        <span class="text-right col-sm-6 text-14">{!! moneyFormat($symbol, $booking->original_pets_charge)!!}</span>
                                                    </p>
                                                @endif
