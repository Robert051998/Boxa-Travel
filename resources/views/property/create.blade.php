...
<main>
	<div class="row m-0">
		...
		<div class="col-xl-10 col-lg-9 min-height right-section mb-5">
			<div class="main-panel">
				<h3 class="mt-5 mb-3">{{trans('messages.property.list_space')}}</h3>
				<p class="mb-5 property_title">{{trans('messages.property.property_title')}}.</p>
