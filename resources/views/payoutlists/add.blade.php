                ...
                <div class="row justify-content-between mt-4">
                  <div class="p-3">
                      <a href="{{url('users/payout-list')}}">
                        <button type="button" class="button button-reactangular vbtn-danger pl-5 pr-5">Cancel</button>
                      </a>
                  </div>

                  <div class="p-3">
                    <button type="submit" class="button button-reactangular vbtn-default pl-5 pr-5" id="submitBtn">
                        Submit
                    </button>
                  </div>
                </div>
