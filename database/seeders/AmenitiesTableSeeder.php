...
class AmenitiesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('amenities')->insert([
        		...
        		['type_id' => '3', 'title' => 'Energy efficiency','description' => 'Energy efficiency','symbol' => 'ok'],
        		['type_id' => '3', 'title' => 'Water conservation','description' => 'Water conservation','symbol' => 'ok'],
        		['type_id' => '3', 'title' => 'Renewable energy','description' => 'Renewable energy','symbol' => 'ok'],
        		['type_id' => '3', 'title' => 'Sustainable materials','description' => 'Sustainable materials','symbol' => 'ok'],        		
        		['type_id' => '3', 'title' => 'Outdoor conservation','description' => 'Outdoor conservation','symbol' => 'ok'],
        		['type_id' => '3', 'title' => 'Waste recycling','description' => 'Waste recycling','symbol' => 'ok'],
        		['type_id' => '3', 'title' => 'Outdoor activities','description' => 'Outdoor activities','symbol' => 'ok'],
        		['type_id' => '3', 'title' => 'Local or organic food','description' => 'Local or organic food','symbol' => 'ok'],
        		['type_id' => '3', 'title' => 'Ecological cleaning products','description' => 'Ecological cleaning products','symbol' => 'ok'],
        		['type_id' => '3', 'title' => 'Access to public transport','description' => 'Access to public transport','symbol' => 'ok'],
        	]);
    }
}
