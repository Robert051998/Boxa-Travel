...
class Bookings extends Model
{
    ...
    public function currency_adjust($field)
    {
        ...
        $rate = Currency::all()->where('code', $this->attributes['currency_code'] ??  $default_currency)->first()->rate;


        $base_amount = $this->attributes[$field] / $rate;


        $session_rate = Currency::all()->where('code',$default_currency)->first()->rate;
    ...
    public function getOriginalPetsChargeAttribute()
    {
        return $this->attributes['pets_charge'];
    }    
    ...
    public function getPetsChargeAttribute()
    {
        return $this->currency_adjust('pets_charge');
    }
    ...
    public function getAttachmentAttribute() {
        ...
        return url('/uploads/booking/'. $this->attributes['attachment']);
    }
}
