...
class Properties extends Model
{
    ...
    public function certification_documents()
    {
        return $this->hasMany('App\Models\CertificationDocument', 'property_id', 'id');
    }
    ...
    public function getOverallRatingAttribute()
    {
        ...
        $avg     = $reviews->count() > 0 ? @($reviews->sum('rating') / $reviews->count()) : 0;
    ...
    // public function getGreenScoreAttribute() {
    //     $this->attributes['green_score'];
    // }
}
