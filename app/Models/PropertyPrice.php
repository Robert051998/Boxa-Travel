...
class PropertyPrice extends Model
{
    ...
    public function getDefaultCodeAttribute()
    {
        if (Session::get('currency')) {
            ...
            return Currency::all()->firstWhere('default', 1)->code;
        }
    }
    ...
    {
        if (Session::get('currency')) {
            return Currency::all()->firstWhere('code', Session::get('currency'))->symbol;;
        } else {
            return Currency::all()->firstWhere('default', 1)->symbol;
        }
    }
