...
class CalendarController extends Controller
{
    ...
    public function generate($property_id = '', $year = '', $month = '')
    {
        ...
        $out .= '<div class="col-md-12 col-sm-12 col-xs-12 p-0">';
        $out .='<div class="row m-0 mt-4 bg-lightgreen">
                    <div class="col-md-2"><div class="wkText">Mon</div></div>
                    <div class="col-md-2"><div class="wkText">Tue</div></div>
                    <div class="col-md-2"><div class="wkText">Wed</div></div>
                    <div class="col-md-2"><div class="wkText">Thu</div></div>
                    <div class="col-md-2"><div class="wkText">Fri</div></div>
                    <div class="col-md-2"><div class="wkText">Sat</div></div>
                    <div class="col-md-2"><div class="wkText">Sun</div></div>
                </div><div class="calenBox row m-0">';
    ...
    public function icalendarExport(Request $request)
    {
        ...
        foreach ($result as $row) {
            // 2. Create an event
            //$sdate = DateTimeImmutable::createFromFormat('Y-m-d', '2020-01-03 13:00:00');
           // $sdate= new \DateTime($row->date);
            $vEvent = new \Eluceo\iCal\Domain\Entity\Event();
           // $occurrence = new \Eluceo\iCal\Domain\ValueObject\TimeSpan(new \Eluceo\iCal\Domain\ValueObject\DateTime($row->date), new \Eluceo\iCal\Domain\ValueObject\DateTime($row->date));
            
           $date = new \Eluceo\iCal\Domain\ValueObject\Date(\DateTimeImmutable::createFromFormat('Y-m-d', $row->date));
