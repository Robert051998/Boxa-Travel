...
class BookingController extends Controller
{
    ...
    */
    public function requestPayment(Request $request){
        ...
        $data['number_of_pets'] = $booking->pets;
        ...
        Session::put('payment_number_of_pets',  $booking->pets);
    ...
    */
    public function requested(Request $request)
    {
        ...
        $data['price_list'] = json_decode($this->helper->getPrice(
            $data['booking_details']->property_id, 
            $data['booking_details']->start_date, 
            $data['booking_details']->end_date, 
            $data['booking_details']->guest, 
            $data['booking_details']->pets, 
        true));
        $data['symbol'] = $this->helper->getCurrentCurrencySymbol();
    ...
    */
    ...
    public function hostCancel(Request $request, EmailController $email)
    {
        ...
        if ($bookings->host_id != Auth::user()->id) {
        ...
        if ($now < $booking_end) {
            ...
            $booking_details->value      = $request->cancel_reason ? $request->cancel_reason : 'Cancelled by host';
            $booking_details->save();
