    ...
    public function edit(Request $request) {        
       if (! $request->isMethod('post')) {
            ...
            if ($request->status == 'Success') {
                ...
                $wallet = Wallet::where('user_id', $withDrawal->user_id)->where('wallet_type', 'currency')->first();
                ...
                if ($wallet->balance >= $subTotal) {
                    ...
                    Wallet::where(['user_id' =>$withDrawal->user_id])->where('wallet_type', 'currency')->update(['balance' => $balance]);
                } else {
