...
class BookingsController extends Controller
{
    ...
    public function getDistinctCurrencyTotalWithSymbol($different_currency_total)
    {
        ...
        foreach ($different_currency_total as $key => $value) {
            $current_currency_symbol = Currency::all()->where('code', $value->currency_code)->first();
    ...
    public function pay(Request $request)
    {
        ...
        $data['currency_default'] = Currency::all()->where('default', 1)->first();
    ...
    public function bookingPdf($id = null)
    {
        ...
        $data['companyLogo']  = $logo  = Settings::all()->where('name', 'logo')->first()->value;
